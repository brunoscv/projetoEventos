...
<div id="main-wrapper" class="container">
	<!-- <div class="alert alert-warning" style="height: 4em">
		<?php if(!$listaConsultaGerada) { ?>
			<span id="com-consulta-aviso"><strong><i class="fa fa-info-circle"></i></strong> <i>Não há consultas geradas para o dia <?php echo date("d/m/Y");?>. Por favor, clique no botão ' + Gerar Consultas ' à sua direita.</i></span>
			<button type="button" id="btn-gerarconsultas" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Gerar Consultas</button>
		<?php } else { ?>
			<span id="sem-consulta-aviso"><strong><i class="fa fa-check"></i></strong> <i>As consultas para a data atual foram geradas com sucesso.</i></span>
		<?php } ?>
	</div> -->
	<div class="row">
		<div class="col-md-12">
